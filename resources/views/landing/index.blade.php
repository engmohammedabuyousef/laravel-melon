...
<head>
    ...
    <meta name="description"
        content="Discover our wide range of products and services for all your home improvement needs. Get expert advice and find the best deals today.">
    <meta name="keywords" content="home improvement, DIY, tools, renovation, remodeling">

    <!-- Favicons -->
    <link href="{{ asset('assets/media/logos/favicon.png') }}" rel="icon">
...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <div class="logo">
                <h1 class="text-light"><a href="/"><span>Melon</span></a></h1>
        ...
        <div class="container">
            <div class="row gy-4">
                <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    <h1>Bettter digital experience with Melon</h1>
                ...
                <div class="col-lg-6 order-1 order-lg-2 hero-img">
                    <img src="{{ asset('assets/landing/img/hero-img.svg') }}" class="img-fluid animated" alt="">
                </div>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="row justify-content-between">
                    <div class="col-lg-5 d-flex align-items-center justify-content-center about-img">
                        <img src="{{ asset('assets/landing/img/about-img.svg') }}" class="img-fluid" alt=""
                            data-aos="zoom-in">
                    </div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="clients-slider swiper" data-aos="fade-up" data-aos-delay="100">
                    <div class="swiper-wrapper align-items-center">
                        <div class="swiper-slide"><img src="{{ asset('assets/landing/img/clients/client-1.png') }}"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('assets/landing/img/clients/client-2.png') }}"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('assets/landing/img/clients/client-3.png') }}"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('assets/landing/img/clients/client-4.png') }}"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('assets/landing/img/clients/client-5.png') }}"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('assets/landing/img/clients/client-6.png') }}"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('assets/landing/img/clients/client-7.png') }}"
                                class="img-fluid" alt=""></div>
                        <div class="swiper-slide"><img src="{{ asset('assets/landing/img/clients/client-8.png') }}"
                                class="img-fluid" alt=""></div>
                    </div>
    ...
    <footer id="footer">
        ...
        <div class="container py-4">
            <div class="copyright">
                &copy; Copyright <strong><span>Melon</span></strong>. All Rights Reserved
            </div>
        </div>
    </footer><!-- End Footer -->
