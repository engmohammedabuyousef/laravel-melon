				...
				<div class="menu-sub menu-sub-accordion">
					...
					<div data-kt-menu-trigger="click" class="menu-item menu-accordion mb-1 {{ request()->routeIs('user-management.users.*') ? 'here show' : '' }}">
						...
						<div class="menu-sub menu-sub-accordion">
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link {{ request()->routeIs('user-management.users.show') ? 'active' : '' }}" href="{{ route('user-management.users.show', 1) }}">
									<span class="menu-bullet">
										<span class="bullet bullet-dot"></span>
									</span>
					...
					<div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ request()->routeIs('user-management.roles.*') ? 'here show' : '' }}">
						...
						<div class="menu-sub menu-sub-accordion">
							...
							<div class="menu-item">
								<!--begin:Menu link-->
								<a class="menu-link {{ request()->routeIs('user-management.roles.show') ? 'active' : '' }}" href="{{ route('user-management.roles.show', 1) }}">
									<span class="menu-bullet">
										<span class="bullet bullet-dot"></span>
									</span>
